================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : hipara Project Overview
===============================================================================

The application wizard has created this hipara application for
you.  This application not only demonstrates the basics of using the Microsoft
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your hipara application.
...
res\hipara.ico
    ...
    icon is included by the main resource file hipara.rc.
...
hiparaDlg.h, hiparaDlg.cpp - the dialog
    These files contain your CHiparaDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in hipara.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CHiparaDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named hipara.pch and a precompiled types file named StdAfx.obj.
