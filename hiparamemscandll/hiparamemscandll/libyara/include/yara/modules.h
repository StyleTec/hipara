...
extern "C" int yr_modules_initialize(void);


extern "C" int yr_modules_finalize(void);


extern "C" int yr_modules_do_declarations(
    const char* module_name,
    YR_OBJECT* main_structure);


extern "C" int yr_modules_load(
    const char* module_name,
    YR_SCAN_CONTEXT* context);


extern "C" int yr_modules_unload_all(
    YR_SCAN_CONTEXT* context);


extern "C" void yr_modules_print_data(
    YR_SCAN_CONTEXT* context);
#endif
