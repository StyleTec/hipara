...
#include <libyara\include\yara\yr_limits.h>
#include <libyara\include\yara\error.h>
#include <libyara\include\yara\object.h>
#include <libyara\include\yara\modules.h>
#include <libyara\include\yara\re.h>
  ...
  while(1)
  {
    switch(*ip)
    {
      ...
      case OP_INDEX_ARRAY:
        ...
        object = yr_object_array_get_item(object, 0, (int)r1);
      ...
      case OP_INT8:
        pop(r1);
        push(read_int8_t(context->mem_block, (size_t)r1));
        break;

      case OP_INT16:
        pop(r1);
        push(read_int16_t(context->mem_block, (size_t)r1));
        break;

      case OP_INT32:
        pop(r1);
		push(read_int32_t(context->mem_block, (size_t)r1));
        break;

      case OP_UINT8:
        pop(r1);
		push(read_uint8_t(context->mem_block, (size_t)r1));
        break;

      case OP_UINT16:
        pop(r1);
		push(read_uint16_t(context->mem_block, (size_t)r1));
        break;

      case OP_UINT32:
        pop(r1);
		push(read_uint32_t(context->mem_block, (size_t)r1));
        break;
